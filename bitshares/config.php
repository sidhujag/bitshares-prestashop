...
if (!defined('ROOT')) {
  ...
  define('baseURL', 'http://www.bitsharesdemo.com/presta/');
  define('accountName', 'opencartdemo');
  define('rpcUser', 'user');
  define('rpcPass', 'pass');
  define('rpcPort', '1234');
  define('demoMode', TRUE);
  define('hashSalt', 'prestademo');
  ...
  define('primaryTickerAssets', 'GOLD, SILVER'); 
  define('secondaryTickerAssets', 'USD, EUR, CNY');  
}
?>
